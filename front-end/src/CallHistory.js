    ...
    return (
        <div className='call-history'>
            <div className="header">
                <button onClick={handleBack} className="back-button" id="backBtnCallHistory">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 79 71" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M31.9527 15.6582C33.2382 16.8135 33.2382 18.6866 31.9527 19.8419L17.8219 32.5417H69.1252C70.9431 32.5417 72.4168 33.8662 72.4168 35.5C72.4168 37.1339 70.9431 38.4584 69.1252 38.4584H17.8219L31.9527 51.1582C33.2382 52.3135 33.2382 54.1866 31.9527 55.3419C30.6672 56.4972 28.5831 56.4972 27.2976 55.3419L7.5476 37.5919C6.26213 36.4366 6.26213 34.5635 7.5476 33.4082L27.2976 15.6582C28.5831 14.5029 30.6672 14.5029 31.9527 15.6582Z" fill="black"/></svg>
                </button>
